...
router.post('/', [auth, [
  ...
  check('skills', 'Skills are require').not().isEmpty(),
]], async (req,res) => {
  ...
  req.body.githubusername ? profileFields.githubusername = req.body.githubusername : null;
  req.body.skills ? profileFields.skills = req.body.skills.split(',').map(skill => skill.trim()) : null;
  // creating socials
  ...
  req.body.facebook ? profileFields.social.facebook = req.body.facebook : null;
  req.body.linkedin ? profileFields.social.linkedin = req.body.linkedin : null;
  req.body.instagram ? profileFields.social.instagram = req.body.instagram : null;
...
router.get('/user/:user_id', async(req,res) => {
  try {
    ...
    profile ? res.json(profile) : res.status(400).send({msg: 'No such profile'});
